  ...
  <body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <form id="form" method="POST" action="traitement/klogin.php">
            ...
            <button type="submit" class="btn btn-primary btn-block" href="#">Se connecter</button>
          </form>
          <div class="text-center">
            <a class="d-block small mt-3" href="register.php">Pas encore inscrire</a>
